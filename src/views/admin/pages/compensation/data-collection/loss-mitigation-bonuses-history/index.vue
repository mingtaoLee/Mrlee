      ...
      return {
        ...
        table: {
          columns: [
            ...
            { prop: 'areaId', label: '区域', width: '140', align: 'left' },
            { prop: 'total', label: '区总', width: '140', align: 'left' },
            { prop: 'orgUnitName', label: '门店名称', width: '140', align: 'left' },
            { prop: 'orgUnitCode', label: '店编', width: '120', align: 'left' },
            { prop: 'bigTarget', label: '大店', width: '120', align: 'left' },
            ...
            // { prop: 'lastUpdateDate', label: '操作时间', width: '140', align: 'left', display: {date: ''} }
          ],
          setting: {
            export: {
            ...
            toolbar: [{
              text: '返回',
              func: () => {
                this.$router.push('/compensation/data-collection/loss-mitigation-bonuses')
              }
            }, {
              text: '确认无误',
