<template>
  <div headerKey="cpsProfitBonusAreasDetailsGet">
  ...
  export default {
    ...
    data () {
      return {
        ...
        dataConfirmConfig: { req: req, name: 'areaManagerConfirmData', params: {} },
        isolateConfig: { req: req, name: 'getNewProfitsBonusOne' },
        reqConfig: { req: req, getName: 'getAreaManagerList', deleteListName: '' },
        effectStartOptions: {
          disabledDate: (time) => {
        ...
        table: {
          columns: [
            ...
            {prop: 'areaProfit', label: '区域利润', width: '120', align: 'right', display: { mixin: (row, col) => this.currencyFormat(row[col]) }},
            ...
            {prop: 'areaNewProfitBonus', label: '区域新店利润分红', width: '140', align: 'right', display: { mixin: (row, col) => this.currencyFormat(row[col]) }},
            {prop: 'shouldProfitBonus', label: '应发利润分红', align: 'right', width: '120', display: { mixin: (row, col) => this.currencyFormat(row[col]) }},
          ...
          setting: {
            export: {
              ...
              req: config.getAreaManagerList,
              key: 'cpsProfitBonusAreasDetailsExport'
            },
            import: {
              key: 'cpsProfitBonusAreasDetailsImport',
              business: 'cps-profit-bonus-area',
              show: () => ({ empty: false })
            },
            operator: [
//              {
...
//              }
            ...
            toolbar: [{
              ...
              text: '确认无误',
              key: 'cpsProfitBonusAreasDetailsPut',
              func: (vm) => {
