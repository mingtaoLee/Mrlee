<template>
  <i-layout headerKey="cpsEmpPayStandardHistoryTwoGet">
...
<script>
  ...
  export default {
      ...
      return {
        ...
        table: {
          columns: [
            ...
            // { prop: '', label: '工资类型', width: '120', align: 'left' },
            ...
            { prop: 'adjustReason', label: '调薪原因', align: 'left', width: '120', display: { dict: '' } },
          ...
          setting: {
            export: {
              ...
              key: 'cpsEmpPayStandardHistoryExport',
              req: config.getSalaryHistoryList
            },
            toolbar: [{
              text: '返回',
              type: 'plain',
    ...
    methods: {
      ...
      fetch (options = {}) {
        this.load()
        req('getSalaryHistoryList', options).then(res => {
