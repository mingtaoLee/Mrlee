<template>
  <i-layout headerKey="cpsTemplateSelectGet">
    ...
    <template slot="section">
      ...
      >
        <TaxTplModify
          v-loading="isTaxTplModifyLoading"
          :element-loading-text="$loadingText"
          :form="form"
          ref="TaxTplModify"
        ></TaxTplModify>
...
<script>
  ...
  import TaxTplModify from './tax-tpl-modify'
  import TaxTplFormatModify from './tax-tpl-format-modify'
...
//        loading: true,
    ...
    methods: {
      ...
      modifyRow (scope) {
        this.title = '个税申报模板修改'
//        Object.assign(this.form, {
//          iitTemplateId: scope.iitTemplateId,
//          iitTemplateName: scope.iitTemplateName,
//          areaId: scope.areaId,
//          companyName: scope.companyName,
//          companyCode: scope.companyCode,
//          effectiveDate: new Date(scope.effectiveDate),
//          uneffectiveDate: new Date(scope.uneffectiveDate),
//          remark: scope.remark
//        })
        this.isTaxTplModifyLoading = true
