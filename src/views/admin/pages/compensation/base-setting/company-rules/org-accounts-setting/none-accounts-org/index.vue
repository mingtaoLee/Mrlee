<template>
  <i-layout v-loading="loading" :element-loading-text="$loadingText" headerKey="cpsPersonnelNoAccountSelectGet">
        ...
        table: {
          ...
          setting: {
            export: {
              ...
              key: 'cpsPersonnelNoAccountExport',
              req: config.getNoneAccountOrgs
            },
            operator: [
              {
                key: 'cpsPersonnelNoAccountCreatePost',
                text: '设置户头',
