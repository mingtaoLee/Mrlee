...
export class BaseEditor {
  constructor (opt) {
    proxy.call(this, opt)
    this.datesKey = ['openingDate', 'effectiveDate', 'uneffectiveDate', 'addApplyDate', 'addEffectiveDate', 'delApplyDate', 'delEffectiveDate']
  }
  initData () {}
  ...
  save () {
    ...
    return new Promise(resolve => {
      req('postAccounts', submitData).then(res => {
