...
<script>
  ...
  export default {
    ...
    computed: {
      isOverTime (value) {
        return !!this.accountPersonnelId
    ...
    methods: {
      getInfo (value) {
        if (this.form.accountCode === '') {
          ...
          reqIndex('getOhterInfo', { accountCode: this.form.accountCode, insuranceType: value }).then(res => {
