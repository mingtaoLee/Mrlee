      ...
      <div slot="scaReportFormFillIn">
        ...
        <div class="content-follow">
          ...
          <div class="info-content">
            <div class="mt10 mb20">
              ...
              :tableModel="planModel" @likeCostChange="changeEffect" @change="changeEffect" edite-cell new-shop />
            </div>
            <div class="mt10 mb20">
        ...
        <div class="content-follow">
          ...
          <div class="info-content">
            ...
            :tableModel="planModel" edite-cell new-shop ref="effectTable" />
          </div>
        </div>
      </div>
...
export default {
  ...
  data () {
    return {
      processType: 'newStoreScaReportCreateProcess',
  ...
  methods: {
    ...
    // 获取维护功能
    getAction () {
      this.$route.query.modify && (this.action = '修改新店编制计划') && (this.taskId = 'todo')
    },
    // 获取路由上的header和data
    getTableDetail () {
    ...
    changeEffect (target) {
      ...
      this.$refs.effectTable.predictNewShopEffect(this.tempPredict.likeCost, this.tempPredict.scaNum, this.tempPredict.dailySales)
    }
  },
