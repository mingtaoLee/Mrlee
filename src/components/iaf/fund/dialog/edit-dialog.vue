      ...
      >
        <div>
          ...
          <el-form-item label="银行类型" prop="cardType">
            <i-select v-model="dialogForm.cardType" parameter="BANK_TYPE"></i-select>
          </el-form-item>
          <el-form-item label="一类建行卡号" prop="cardNumber">
            <el-input v-model="dialogForm.cardNumber"></el-input>
          </el-form-item>
          <el-form-item label="公司基数" prop="compPayBase">
        ...
        <div>
          ...
          <el-form-item label="公积金账号" prop="empHpfundAccount">
            <el-input v-model="dialogForm.empHpfundAccount"></el-input>
          </el-form-item>
          <el-form-item label="银行卡号" prop="cardId">
            <el-input v-model="dialogForm.cardId"></el-input>
          </el-form-item>
          <el-form-item label="参保时间" prop="increaseDate">
            <el-date-picker 
              type="date" 
          ...
          <el-form-item label="个人基数" prop="empPayBase">
  ...
  export default {
    ...
    computed: {
      rules () {
        return {
          ...
          householdCode: [
            {
              required: true, message: '请输入户头户口性质 '
            }
          ],
          empHpfundAccount: [
            {
              required: true, message: '请输入公积金账号'
            }
          ],
          cardType: [
            {
              required: true, message: '请输入银行类型'
            }
          ],
          cardId: [
            {
    ...
    methods: {
      handleOptionClick (item) {
        ...
        req('limitPayBase', {householdCode: this.dialogForm.householdCode, accountCode: this.dialogForm.accountCode, insuranceType: '0A', employeeCode: this.dialogForm.employeeCode}).then(datas => {
          let obj = {}
