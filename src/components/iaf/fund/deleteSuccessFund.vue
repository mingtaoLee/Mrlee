...
export default {
      ...
      table: {
        ...
        setting: {        // 可编辑表格的相关设置【可选】
          ...
          export: {
            ...
            req: config.fundQueryDeleteSuccessSearch,        // api 配置信息（参数名以自身业务为准）【必填】
  ...
  methods: {
    fetch (options = {}) {
      ...
      req('fundQueryDeleteSuccessSearch', Object.assign({}, options, this.newSearchData,
